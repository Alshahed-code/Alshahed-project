      ...
      <header class="header1" data-header>
         <div class="container1">
            ...
            <a href="#" class="logo">
               ...
               <span class="al-sh"><span>Al</span>shahed</span>
            </a>
            <nav class="navbar1" data-navbar>
               <div class="wrapper1">
                  <a href="#" class="logo">
                     <img src="images/logo alshahed.png" width="50" height="50" alt="logo">
                  </a>
               ...
               <ul class="navbar-list1">
                  ...
                  <li class="navbar-item1">
                     <a href="#home" class="navbar-link1 id-activ" data-nav-link style="color: #000">Home</a>
                  </li>

                  <li class="navbar-item1">
                     <a href="#about" class="navbar-link1" data-nav-link>About</a>
                  </li>

                  <li class="navbar-item1">
                     <a href="{{url('our_shop')}}" class="navbar-link1" data-nav-link>Our shop</a>
                  </li>

                  <li class="navbar-item1">
                     <a href="#contact" class="navbar-link1" data-nav-link>Contact Us</a>
                  </li>
                  ...
                  @else 
                  <div class="nav-icons">
                    <a href="{{url('mycart')}}"><i class='bx bx-cart'>[]</i></a>
                  </div>
            ...
            <div class="overlay1" data-nav-toggler data-overlay></div>
         </div>
      </header>
      <!-- Modal -->
                  ...
                  <aside class="shop-aside col-lg-3 col-md-4 mb-6 mb-md-0">
                     <div class="offcanvas offcanvas-start offcanvas-collapse w-md-50" tabindex="-1"
                        ...
                        <div class="offcanvas-body ps-lg-2 pt-lg-0">
                           <div class="mb-8">
                              <!-- title -->
                              <h5 class="mb-3" style="color: #ff9f0d">Categories</h5>
                              <!-- nav -->
                              <ul class="nav nav-category" id="categoryCollapseMenu">
                                 @foreach ($category as $category)
                            <li class="nav-item border-bottom w-100">
                              <a href="{{url('category', $category->id)}}" class="nav-link">
                         ...
                         @endforeach
                           ...
                           <div class="mb-8 position-relative">
                              ...
                              <!-- Banner Image -->
                              <!-- img -->
                              <img src="{{asset('images/pexels-three-shots-21264-714522.jpg')}}" alt=""
                     ...
                     <div class="card mb-4 bg-light border-0">
                        ...
                        <div class="card-body-1 card-body p-9">
                           <h2 class="mb-0 fs-1 h2-header-bee">
                             ...
                             <span style="color: #222">{{isset($selected_category) ? $selected_category->category_name : 'All Products'}}</span> 
                           </h2>
                        </div>
                     </div>
                     <!-- list icon -->
                           ...
                           <div class="mt-3 row justify-content-start g-2 align-items-center">
                              <div class="col-lg-4 col-md-5 col-6 d-grid">
                                 ...
                                 <button type="button" class="btn btn-primary">
                                    ...
                                    <a href="{{asset('mycart')}}">Add to cart</a>
                                 </button>
                              </div>
